...
public class JWTTokenUtil {
     ...
     * @return
     */
    public static String createTokenBody( String userId){
        Date iat = new Date();
        //token
     ...
     * @return
     */
    public static String createAskKey(String bodyCode) throws Exception{
        //字符串转换
    ...
    public static void main(String[] args) throws Exception{
        String tokenStr = createTokenStr("4");
        // 表头信息
        String bodyCode = tokenStr.substring(0,tokenStr.indexOf("."));
        System.out.println(bodyCode);
        // 密钥信息
        String messCode = tokenStr.substring(tokenStr.indexOf(".")+1,tokenStr.length());
        System.out.println(messCode);
        String sayCode = createAskKey(Md5Util.decryptBASE64(bodyCode));

        System.out.println(messCode.equals(sayCode));
