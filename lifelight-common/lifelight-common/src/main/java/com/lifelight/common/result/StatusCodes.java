...
/**
 * Error codes class that mainly contains the HTTP status codes. As much as possible use the status codes defined in the
 * HTTP standard and only add new ones if really needed.
 */
public class StatusCodes {
    ...
    public static final int DEFAULT_REPAYMENT_ING=600;
    public static final int ACCOUNT_FROZEN_ING=900;
