...
public class DeviceInfoController {
	...
	@ResponseBody
	public Result selectDeviceInfoListPage(HttpServletRequest request,
	...
	@ResponseBody
	public Result insertDeviceInfo(HttpServletRequest request,@RequestBody DeviceInfo deviceInfo) {
	...
	@ResponseBody
	public Result updateDeviceInfo(HttpServletRequest request,@RequestBody DeviceInfo deviceInfo) {
		if (!StringUtil.isEmpty(deviceInfo.getManagerId())) {
			//获取微信配置id
			logger.info("域名：：：："+request.getServerName());
			String domainName = request.getServerName();
	...
	@ResponseBody
	public Result getDeviceInfoById(HttpServletRequest request,@RequestParam("id") Integer id) {
