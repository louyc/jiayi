...
public class ServiceController {
	...
	@ResponseBody
	public Result getServiceInfoByType(HttpServletRequest request,
	...
	@ResponseBody
	public Result queryAllServiceInfo(HttpServletRequest request,
		...
		return serviceService.queryAllServiceInfo(createUserId,Integer.parseInt(weixinId));
	}
