layui.use(['form','laypage','layer','jquery','laydate'], function(){
	...
	form.on('select(buildType)', function(data){
	    ...
	    if(value == "4" || value == "2"){
	    	...
	    	$("#signPersonType").attr("disabled","disabled")
	    	$("#servicePackage").attr("disabled","disabled")
	    	form.render()
	    }else{
	    	$("#ageId").removeAttr("disabled");
	    	$("#startTime").removeAttr("disabled")
	    	$("#endTime").removeAttr("disabled")
	    	$("#signPersonType").removeAttr("disabled")
	    	$("#servicePackage").removeAttr("disabled")
	    	form.render()
	    }
	});
	getServicePackage();
    ...
    function getData(pageNum,pageSize){
	    ...
	    obj.signPersonType = $("#signPersonType").val()=="all"?"":$("#signPersonType").val();
	    obj.servicePackage = $("#servicePackage").val()=="all"?"":$("#servicePackage").val();
	        ...
	        success : function(data){
	            ...
	            if(data.successful){
	            	...
	            	for(var i=0;i<list.length;i++){
	        			...
	        			if(list[i].buildType == "1" || list[i].buildType == "3" ){
	            	...
	            	$(".dataInfo").on("click",function(){
	            		var managerId = $(this).next("button").attr("data-id");
