layui.use(['element','form','laypage','layer','jquery','laydate'], function(){
    ...
    function getData(type){
    	...
    	startTime = $("#startTime").val()||window.utils.simpleDateFormat(times,'yyyy-MM-dd');
    	endTime =$("#endTime").val()||window.utils.simpleDateFormat(times.getTime()+6*24*3600*1000,'yyyy-MM-dd');
