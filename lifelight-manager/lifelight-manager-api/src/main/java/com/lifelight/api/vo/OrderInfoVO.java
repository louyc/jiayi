...
public class OrderInfoVO implements Serializable {
	...
	private Integer mailStatus; //邮寄状态
	private String isInvoice; // 是否开发票  1：是  2：否
	private String invoiceType;//发票类型 ：1普通发票  2：电子发票
	private String invoiceTitleType;//发票抬头类型 1：个人  2：单位
	private String taxpayer;//纳税人
	private String taxpayerNumber;// 纳税人识别号
	private String ticketCollectorMobile;// 收票人电话
	private String ticketCollectorEmail;//  收票人邮箱
	//20180515
	private String commission;//佣金
	private String commissionPayStatus; //佣金发送状态 1：成功  2：失败
	private String sendListid;   //微信单号
	private Date sendTime; //微信发送成功时间
	...
	public String getCommissionPayStatus() {
		return commissionPayStatus;
	}

	public void setCommissionPayStatus(String commissionPayStatus) {
		this.commissionPayStatus = commissionPayStatus;
	}
