...
import com.lifelight.dubbo.dao.ImplementSetDetailMapper;
import com.lifelight.dubbo.dao.ImplementSetMapper;
import com.lifelight.dubbo.dao.PersonalTailorMapper;
...
public class ImplementSetServiceImpl implements ImplementSetService {
	...
	@Override
	public Result getImplementSetInfoByType(String type,Integer platformId) {
		Result result = new Result<>(StatusCodes.OK, true);
		List<ImplementSetVO> listImple = new ArrayList<ImplementSetVO>();
		try {
			Map<String, Object> updateMap = new HashMap<String, Object>();
			updateMap.put("type", Integer.parseInt(type));
			updateMap.put("platformId", platformId);
			listImple = implementSetMapper.selectByType(updateMap);
	...
	@SuppressWarnings({ "rawtypes", "unchecked" })
	@Override
	public Result getImplementFind(String type,Integer platformId) {
		Result result = new Result<>(StatusCodes.OK, true);
		List<ImplementSetVO> listImple = new ArrayList<ImplementSetVO>();
		try {
			Map<String, Object> updateMap = new HashMap<String, Object>();
		...
		try {
			...
			if (null != implementSet.getImplementList()
				...
				for (ImplementSetVO imp : implementSet.getImplementList()) {
					...
					imp.setPlatformId(implementSet.getPlatformId());
				}
			}
