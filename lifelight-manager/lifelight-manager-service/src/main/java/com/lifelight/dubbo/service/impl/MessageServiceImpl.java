...
public class MessageServiceImpl implements MessageService {
	 ...
	 */
	@Override
	public PaginatedResult<MessageVO> selectMessageListPage(Message message) {

		List<MessageVO> MessageList = messageMapper.selectMessageListPage(message);
		// 总页数
		int totalCount = message.getTotalResult();
		PaginatedResult<MessageVO> pa = new PaginatedResult<MessageVO>(MessageList,
	 ...
	 */
	@Override
	public Result<?> selectMessageCount(Message message) {
		
		Result result = new Result<>(StatusCodes.OK, true);
		List<MessageVO> messageList = messageMapper.selectMessageCount(message);
		// 总页数
	...
	@Override
	public Result<?> sendDoctorMessage(String doctorId, String toUserId, String content,Integer platformId) {
		// 创建发送消息
	...
	@Override
	public Result<?> sendDoctorMessageList(String doctorId, List<String> toUserIds, String content,Integer platformId) {
		Result<?> result = new Result<>(StatusCodes.OK, true);
